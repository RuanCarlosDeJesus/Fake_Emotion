  ...
  return (
    <div className="min-h-screen flex justify-center selection:bg-fuchsia-500">
      <div className="w-full md:max-w-[45%] flex flex-col md:shadow-[0_10px_40px_rgba(0,0,0,0.90)]">
        ...
        <header className="mt-3 md:sticky top-0 z-50 w-full shadow-[0_10px_40px_rgba(0,0,0,0.90)] border-b border-white/10 bg-black/20 backdrop-blur-md">
          ...
          {open && (
            <div className="md:hidden">
              ...
              />
              <div className="fixed right-0 top-0 h-full w-80 border-l border-white/10 p-6 flex flex-col bg-black z-50">
                ...
                <div className="flex flex-col gap-4 text-white shadow-[0_10px_40px_rgba(0,0,0,0.90)] p-9 text-xl">
                  {allLinks.map((l, index) => (
                    <a key={index} href={l.href} onClick={() => setOpen(false)}>
                      {l.label}
                    </a>
                  ))}
                </div>
        ...
        <main className="bg-[radial-gradient(circle,rgba(0,0,0,0)_40%,rgba(0,0,0,0.7)_100%)]">
          ...
          <h2 className="relative text-3xl md:text-4xl text-white font-semibold text-center my-10 
            before:content-[''] before:absolute before:top-1/2 before:left-0 before:w-1/3 before:h-1.5 before:bg-linear-to-r before:from-transparent before:via-purple-600 before:to-transparent before:-translate-y-1/2
            after:content-[''] after:absolute after:top-1/2 after:right-0 after:w-1/3 after:h-1.5 after:bg-linear-to-l after:from-transparent after:via-purple-600 after:to-transparent after:-translate-y-1/2">
            Destaques
          </h2>
          ...
          <div className="grid md:grid-cols-3 grid-cols-1 gap-10 p-10">
            {imagesData.images.map((item: ImageItem) => (
              <div
                key={item.id}
                className="relative w-full rounded-2xl overflow-hidden border border-pink-500/40 bg-white/5 backdrop-blur-md shadow-[0_0_40px_rgba(236,72,153,0.3)] hover:scale-105 transition duration-500"
              >
                <img
                  src={`/img/${item.file}`}
                  alt={item.name}
                ...
                <div className="absolute bottom-0 w-full p-6 text-center">
                  ...
                  <button className="mt-4 px-6 py-2 rounded-lg cursor-pointer bg-linear-to-r from-fuchsia-600 to-pink-500 text-white shadow-lg">
                    VER
                  </button>
                </div>
              </div>
          ...
          <section id="sobre" className="relative w-full min-h-100 flex items-center justify-center px-6 overflow-hidden p-10">
            <div className="relative z-10 max-w-4xl w-full text-white">
              ...
              <div className="flex gap-6">
                <a
                  ...
                  className="flex items-center gap-2 px-6 py-3 rounded-xl bg-gray-900 hover:bg-black text-white font-medium transition duration-300 shadow-lg"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-6 py-3 rounded-xl bg-[#0A66C2] hover:bg-[#084d91] text-white font-medium transition duration-300 shadow-lg"
                >
          ...
          <footer className="flex justify-center items-center w-full py-8 text-white/60 bg-linear-to-t from-black/80 via-black/30 to-transparent">
